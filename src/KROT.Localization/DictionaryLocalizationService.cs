    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Resources =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["ru"] = new Dictionary<string, string>
            {
                ...
                ["Warning.DisableVpnProxy"] = "Работа через VPN/прокси",
                ...
                ["Action.RecheckService"] = "Перепроверить {0}",
            ...
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["Warning.DisableVpnProxy"] = "Using VPN/proxy",
                ...
                ["Action.RecheckService"] = "Recheck {0}",
