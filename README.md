...
- компактный WPF-интерфейс, панель задач и системный трей со статусной иконкой;
- русский и английский языки;
- отдельное включение Discord и YouTube;
...
- адаптивный каталог Discord и YouTube: 16 TCP/TLS, 8 QUIC и 10 Voice-стратегий;
- быстрый запуск сохранённого победителя, проверка прямого доступа и последовательный TCP-подбор без VPN;
- автоматическая ротация 8 QUIC- и 10 Voice-стратегий по входящему/исходящему UDP-трафику средствами Zapret 2;
- сохранение подтверждённых QUIC/Voice-победителей по сети и фоновое восстановление TCP после двух сбоев;
- отдельная проверка общего интернета, чтобы обрыв Wi-Fi не запускал ложный перебор;
- независимые статусы каналов в интерфейсе и DPI-независимые векторные индикаторы;
